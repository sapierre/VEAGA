...
export const MobileNavigation = ({ links }: NavigationProps) => {
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed left-0 top-14 z-10 flex h-[calc(100vh-3.5rem)] w-full flex-col gap-7 overflow-auto lg:hidden">
        <div
          className={cn(
        ...
        <div
          className={cn(
            "flex w-full -translate-y-full flex-col gap-2 rounded-b-md bg-background px-[1.7rem] pb-6 transition-transform duration-500 ease-out sm:px-8",
            {
